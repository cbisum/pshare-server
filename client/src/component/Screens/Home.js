              ...
              data.map(item => {
                  ...
                  return (
                      <div className='card home-card' key={item._id}>
                          ...
                          {/* <img className='imgicon' src={state.pic} /> */}
                          <Link  className='hovereffect' to={item.postedBy._id !==state._id?'/profile/'+item.postedBy._id:'/profile'} ><span className='hovereffect'>{item.postedBy.name}</span></Link>
                          ...
                          <div className='card-content'>
                              {item.likes.includes(state._id) ? <i className="material-icons"
