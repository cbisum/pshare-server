  ...
  const renderList = ()=>{
      if(state){
        return [
          ...
          <li  key='2'><Link to="/myfollwingpost">My following post</Link></li>,
        ...
        return [
          ...
          <li key='7'><Link to="/signup">Singup</Link></li>
        ]
      }
  }
      ...
      <div id="modal1" className="modal" ref={searchModal} style={{color:'black'}}>
        ...
        <input
          ...
          {userDetails.map(item=>{
            return <Link to={item._id!==state.id?"/profile/"+item._id:'/profile'}
            onClick={()=>{
